...
//     <div
//       className={cn(
//         "group relative flex h-[100%] w-[100%] items-center justify-center bg-white dark:bg-black border-0 border-green-500",
//         containerClassName,
//       )}
...
export const Highlight = ({
  ...
  return (
    ...
    //   #03001e, #7303c0, #ec38bc, #fdeff9
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-[#03001e] via-[#7303c0]  to-[#fdeff9] px-1 pb-1 dark:from-[#7F00FF] dark:via-[#7303c0]  dark:to-[#E100FF]`,
        className,
      )}
    >
      {children}
